...
import { GridViewActionBarItems, QuickActionSectionAlignment } from '../GridView.models';
...
export const getQuickActionBarItems = (quickActionSectionItems = [], params = {}) => {
    ...
    let actionBarLeftItems = quickActionSectionItems.filter((item) => item.alignment === QuickActionSectionAlignment.Left);
    actionBarLeftItems = applySorting(actionBarLeftItems, 'order', SORT_TYPE.ASC);
    let actionBarRightItems = quickActionSectionItems.filter((item) => item.alignment === QuickActionSectionAlignment.Right);
