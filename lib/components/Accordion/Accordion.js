...
export const Accordion = (props) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", Object.assign({ className: mergeClassNames([classes.accordionHeader, props.accordionHeaderClass]), "aria-label": isCollapsed ? 'Click to expand' : 'Click to collpase', "aria-expanded": !isCollapsed, onClick: onToggleAccordion }, { children: [!props.hideToggleButton && (_jsx("div", { className: isCollapsed
