...
import { ColumnActionsMode, Selection } from '@fluentui/react';
...
import { applyPaging, applySorting as applySortingDefault, DEFAULT_PAGE_SIZE, SORT_TYPE } from '../../';
...
export const useSelection = (props, handleSelectionChange) => {
    ...
    const actions = {
        initialize: (props, callbacks) => {
            ...
            const initialData = {
                ...
                columns: updateColumns(state.columns ? state.columns : props.columns, sortingOptions, callbacks.onColumnClick, props.removeSorting || props.allowMultiLevelSorting),
...
const updateColumns = (columns, sortingOptions, onColumnSort, removeSorting) => {
