...
export const useSelection = (handleSelectionChange, items, itemUniqueField) => {
    ...
    const actions = {
        initialize: (props, callbacks) => {
            ...
            const initialData = {
                ...
                columns: updateColumns(props.columns, sortingOptions, callbacks.onColumnClick, props.removeSorting || props.allowMultiLevelSorting),
