...
export const GridView = (props) => {
    ...
    const selection = useSelection(onSelectionChange, props.allowSelection ? props.items : [], props.itemUniqueField);
    React.useEffect(() => {
    ...
    const onFilterChange = (filter) => {
        let selectedFilters = props.gridViewType === GridViewType.InMemory ? state.selectedFilters : filtersToApply;
    ...
    const onApplyFilters = () => {
        ...
        resetSelection();
        props.onHandleChange &&
            props.onHandleChange(getSelections(GridViewChangeType.SelectedFilters, filtersToApply), GridViewChangeType.SelectedFilters);
        toggleFilters(false);
    };
    ...
    const getMessageSection = () => {
        if (StatusMessageSectionComponent) {
            return (_jsx(StatusMessageSectionComponent, { messages: statusMessages, onDissmiss: onDismissMessage }, void 0));
        }
        return (_jsx(StatusMessages, { messages: getUpdatedMessageList(statusMessages), onDismiss: onDismissMessage }, void 0));
    };
    ...
    const getGridViewSection = () => (_jsxs("div", Object.assign({ className: classes.gridViewData }, { children: [getGridViewData(), getGridViewSideFilter()] }), void 0));
    ...
    const getGridViewData = () => {
        ...
        if (GridComponent) {
            return (_jsx("div", Object.assign({ className: items.length ? gridViewDataClass : classes.gridViewNoData }, { children: _jsx(GridComponent, Object.assign({}, props, { items: items || [], columns: columns, selection: selection, groups: props.allowGrouping ? props.groups || state.groups : undefined }), void 0) }), void 0));
        }
        if (CardComponent) {
        ...
        return (_jsx("div", Object.assign({ className: items.length ? gridViewDataClass : classes.gridViewNoData }, { children: _jsx(GridViewDefault, Object.assign({}, props, { items: items || [], columns: columns, selection: selection, groups: props.allowGrouping ? props.groups || state.groups : undefined }), void 0) }), void 0));
    };
    const getGridViewSideFilter = () => {
        ...
        if (SideFilterComponent) {
            return (_jsx(SideFilterComponent, { showFilters: showFilters, toggleFilters: onToggleFilter, filters: filters, onFilterChange: onFilterChange, onApplyFilters: state.gridViewType === GridViewType.ServerSide ? onApplyFilters : undefined }, void 0));
        }
        return (_jsx(GridFilterPanel, { showFilters: showFilters, toggleFilters: onToggleFilter, filters: filters, onFilterChange: onFilterChange, onApplyFilters: state.gridViewType === GridViewType.ServerSide ? onApplyFilters : undefined }, void 0));
    };
    ...
    if (!(state && state.gridViewType >= 0))
        return null;
    return (_jsx(GridViewContext.Provider, Object.assign({ value: { state, actions } }, { children: _jsxs("div", Object.assign({ className: gridContainerClass }, { children: [_jsxs("div", Object.assign({ className: gridActionSectionClass }, { children: [getQuickActionSection(), getMessageSection(), getSelectedFiltersSection()] }), void 0), _jsx("div", Object.assign({ className: props.gridMainClass }, { children: props.isLoading ? (getGridShimmer()) : (_jsxs(_Fragment, { children: [getGridSummarySection(), getGridViewSection(), getNoResultsSection(), getPager()] }, void 0)) }), void 0)] }), void 0) }), void 0));
