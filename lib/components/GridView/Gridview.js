...
export const GridView = (props) => {
    ...
    const renderSaveRecordActionButtons = (item, column) => {
        return (!props.hideInlineEdit && (_jsxs(_Fragment, { children: [_jsx(CommandBarButton, { className: classes.gridviewActionColumnButton, iconProps: { iconName: 'Save' }, title: localizedString(COMMON_LOCALIZATION_STRINGS.SAVE, localization), 
                    //text={localizedString(COMMON_LOCALIZATION_STRINGS.SAVE, localization)}
                    onClick: () => {
                        onSaveRecords([item]);
                    } }, void 0), _jsx(CommandBarButton, { className: classes.gridviewActionColumnButton, iconProps: { iconName: 'Cancel' }, title: localizedString(COMMON_LOCALIZATION_STRINGS.CANCEL, localization), 
    ...
    const renderEditButton = (item) => {
        if (!props.allowEdit) {
            ...
            return (_jsx(CommandBarButton, { className: classes.gridviewActionColumnButton, iconProps: { iconName: 'Edit' }, title: localizedString(COMMON_LOCALIZATION_STRINGS.EDIT, localization), 
    ...
    const renderDeleteButton = (item) => {
        if (!props.allowDelete) {
            ...
            return (_jsx(CommandBarButton, { className: classes.gridviewActionColumnButton, iconProps: { iconName: 'Delete' }, title: localizedString(COMMON_LOCALIZATION_STRINGS.DELETE, localization), 
