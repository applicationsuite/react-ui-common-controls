...
import { GridViewType, GridViewChangeType, DEFAULT_MESSAGE_DISMISS_TIME, OperationType, GRIDVIEW_LOCALIZATION_STRINGS, ControlType, AlignmentType } from './GridView.models';
...
export const GridView = (props) => {
    ...
    const renderSaveRecordActionButtons = (item, column) => {
        return (!props.hideInlineEdit && (_jsxs(_Fragment, { children: [_jsx(CommandBarButton, { className: classes.gridviewActionColumnButton, iconProps: { iconName: 'Save' }, ariaLabel: localizedString(COMMON_LOCALIZATION_STRINGS.SAVE, localization), title: localizedString(COMMON_LOCALIZATION_STRINGS.SAVE, localization), 
                    //text={localizedString(COMMON_LOCALIZATION_STRINGS.SAVE, localization)}
                    onClick: () => {
                        onSaveRecords([item]);
                    } }, void 0), _jsx(CommandBarButton, { className: classes.gridviewActionColumnButton, iconProps: { iconName: 'Cancel' }, ariaLabel: localizedString(COMMON_LOCALIZATION_STRINGS.CANCEL, localization), title: localizedString(COMMON_LOCALIZATION_STRINGS.CANCEL, localization), 
    ...
    const renderEditButton = (item) => {
        if (!props.allowEdit) {
            ...
            return (_jsx(CommandBarButton, { className: classes.gridviewActionColumnButton, iconProps: { iconName: 'Edit' }, ariaLabel: localizedString(COMMON_LOCALIZATION_STRINGS.EDIT, localization), title: localizedString(COMMON_LOCALIZATION_STRINGS.EDIT, localization), 
    ...
    const renderDeleteButton = (item) => {
        if (!props.allowDelete) {
            ...
            return (_jsx(CommandBarButton, { className: classes.gridviewActionColumnButton, iconProps: { iconName: 'Delete' }, ariaLabel: localizedString(COMMON_LOCALIZATION_STRINGS.DELETE, localization), title: localizedString(COMMON_LOCALIZATION_STRINGS.DELETE, localization), 
    ...
    const getGridViewData = () => {
        ...
        if (CardComponent) {
            return (_jsx("div", Object.assign({ className: items.length ? gridViewDataClass : classes.gridViewNoData }, { children: items.map((item, index) => {
