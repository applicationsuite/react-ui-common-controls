...
export const getLocalizedString = (localizationInstance, localizationStringData) => localizationInstance.formatMessage && localizationInstance.formatMessage(localizationStringData);
export const useLocalizedString = (localizationStringData) => {
    const intl = useIntl();
