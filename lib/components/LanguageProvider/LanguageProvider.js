...
export const LanguageProvider = (props) => {
    const browserLanguage = props.language || navigator.language || (navigator.languages && navigator.languages[0]);
    ...
    return (_jsx(LanguageContext.Provider, Object.assign({ value: contextData }, { children: _jsx(IntlProvider, Object.assign({ locale: localization.locale, messages: localization.messages }, { children: props.children }), void 0) }), void 0));
};
