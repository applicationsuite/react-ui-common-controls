...
export const Wizard = (props) => {
    ...
    const getWizardLinks = () => (_jsx(WizardLinks, { type: props.type, steps: state.steps, selectedStep: state.selectedStep, onStepLinkClick: onStepLinkClick, defaultStepLinksCollapse: isCollpased, hideStepStatusConnector: props.hideStepStatusConnector }, void 0));
    ...
    const getVerticalWizard = () => {
        ...
        return (_jsxs(Stack, Object.assign({ horizontal: true, tokens: stackTokens, className: className }, { children: [_jsxs(Stack.Item, Object.assign({ align: "stretch", grow: true, className: wizardLinksClass }, { children: [getWizardLinks(), _jsx("div", Object.assign({ className: isCollpased
    ...
    const getHorizontalWizard = () => {
        ...
        return (_jsxs(Stack, Object.assign({ className: className }, { children: [_jsx(Stack.Item, Object.assign({ align: "center", className: wizardLinksClass }, { children: getWizardLinks() }), void 0), _jsx(Stack.Item, Object.assign({ align: "auto", className: wizardContainerClass }, { children: getStepComponent() }), void 0)] }), void 0));
    };
    if (!state.steps) {
        return null;
    }
