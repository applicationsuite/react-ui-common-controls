                        ...
                        : props.stepClass
                            ...
                            : classes.stepClass }, { children: [_jsxs("button", Object.assign({ type: "button", disabled: link.disabled }, { children: [_jsx(Icon, { className: link.isCurrentItem ? 'active' : getClassName(link.status), iconName: link.icon
                                        ? link.isCurrentItem
                                            ...
                                            : link.icon
                                        : iconMaps[WizardStepStatus.Blocked] }, void 0), _jsx("span", Object.assign({ className: link.isCurrentItem ? classes.activeStep : classes.stepText }, { children: link.name }), void 0)] }), void 0), index !== links.length - 1 && (_jsx(_Fragment, { children: isHorizental ? (_jsx("div", { className: links[index + 1].status === WizardStepStatus.Completed &&
